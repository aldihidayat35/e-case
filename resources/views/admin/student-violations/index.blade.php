...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 my-0">Data Pelanggaran Siswa</h1>
            </div>
            <div>
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <select id="classFilter" class="form-select form-select-solid w-150px me-2">
    ...
    var table = $('#violationsTable').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                searchable: false,
                render: function(data) {
                    return '<span class="badge badge-danger fs-5">' + data + '</span>';
                }
            },
            {
                data: 'action',
