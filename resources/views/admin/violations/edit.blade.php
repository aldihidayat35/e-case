...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="mb-5">
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 my-0">Edit Jenis Pelanggaran</h1>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" name="name" class="form-control form-control-solid @error('name') is-invalid @enderror"
                               placeholder="Contoh: Terlambat Masuk Sekolah" value="{{ old('name', $violation->name) }}" required />
                        @error('name')
                    ...
                    <div class="mb-10">
                        ...
                        <input type="number" name="point_value" class="form-control form-control-solid @error('point_value') is-invalid @enderror"
                               placeholder="Contoh: 5" value="{{ old('point_value', $violation->point_value) }}" min="1" max="100" required />
                        @error('point_value')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-10">
                        ...
                        <textarea name="description" class="form-control form-control-solid @error('description') is-invalid @enderror"
                                  rows="4" placeholder="Masukkan keterangan tambahan tentang jenis pelanggaran ini...">{{ old('description', $violation->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="alert alert-warning d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span>Perubahan pada poin pelanggaran tidak akan mempengaruhi data pelanggaran siswa yang sudah tercatat sebelumnya. Hanya pencatatan pelanggaran baru yang akan menggunakan poin yang telah diubah.</span>
                        </div>
                    </div>
                    <!--end::Warning Alert-->
