        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex justify-content-between align-items-center mb-5">
                    <div>
                        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 my-0">Setting Aplikasi</h1>
                        <span class="text-muted fw-semibold fs-7">Kelola informasi dan pengaturan aplikasi sekolah</span>
                    </div>
                </div>
                <!--end::Header-->
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-10">
                                ...
                                <!--begin::Row-->
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label required fw-semibold fs-6">Nama Sekolah</label>
                                    <div class="col-lg-9">
                                ...
                                <!--begin::Row-->
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6">Alamat Sekolah</label>
                                    <div class="col-lg-9">
                                ...
                                <!--begin::Row-->
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6">NPSN</label>
                                    <div class="col-lg-9">
                                ...
                                <!--begin::Row-->
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6">Akreditasi</label>
                                    <div class="col-lg-9">
                                ...
                                <!--begin::Row-->
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6">Logo Sekolah</label>
                                    <div class="col-lg-9">
                            ...
                            <div class="mb-10">
                                <h3 class="fw-bold text-gray-900 mb-6">Kepala Sekolah</h3>

                                <!--begin::Row-->
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6">Nama Kepala Sekolah</label>
                                    <div class="col-lg-9">
                                ...
                                <!--begin::Row-->
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6">NIP Kepala Sekolah</label>
                                    <div class="col-lg-9">
                            ...
                            <div class="mb-10">
                                <h3 class="fw-bold text-gray-900 mb-6">Visi & Misi</h3>

                                <!--begin::Row-->
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6">Visi Sekolah</label>
                                    <div class="col-lg-9">
                                ...
                                <!--begin::Row-->
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-semibold fs-6">Misi Sekolah</label>
                                    <div class="col-lg-9">
